...
JNIEXPORT void JNICALL Java_org_diskominfo_sisga_facerecognition_NativeMethods_TrainFaces(JNIEnv, jobject, jlong addrImages, jlong addrClasses) {
...
JNIEXPORT void JNICALL Java_org_diskominfo_sisga_facerecognition_NativeMethods_MeasureDist(JNIEnv *env, jobject, jlong addrImage, jfloatArray minDist, jintArray minDistIndex, jfloatArray faceDist, jboolean useEigenfaces) {
    Facebase *pFacebase;
    if (useEigenfaces) {
