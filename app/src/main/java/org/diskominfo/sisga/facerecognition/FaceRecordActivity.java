...
public class FaceRecordActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {

    private static final String TAG = FaceRecordActivity.class.getSimpleName();
    ...
    private void showLabelsDialog() {
        ...
        if (!uniqueLabelsSet.isEmpty()) { // Make sure that there are any labels
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(FaceRecordActivity.this);
            builder.setTitle("Klik username untuk menyimpan foto : ");
...
//            });
            ...
            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(FaceRecordActivity.this, android.R.layout.simple_list_item_1, uniqueLabels) {
                @Override
                public @NonNull
            ...
            ListView mListView = new ListView(FaceRecordActivity.this);
    ...
    private void showEnterLabelDialog() {
        ...
        final EditText input = new EditText(FaceRecordActivity.this);
