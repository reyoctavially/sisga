...
import org.diskominfo.sisga.activity.DataPengajuanCutiActivity;
import org.diskominfo.sisga.activity.PengajuanCutiActivity;
...
public class FaceInActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    private static final String TAG = FaceInActivity.class.getSimpleName();
...
//            });
            ...
            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(FaceInActivity.this, android.R.layout.simple_list_item_1, uniqueLabels) {
                @Override
                public @NonNull
            ...
            ListView mListView = new ListView(FaceInActivity.this);
    ...
    private void showEnterLabelDialog() {
        ...
        final EditText input = new EditText(FaceInActivity.this);
    ...
    private void requestSimpanAbsen(){
        ...
        Date clock = new Date();
        String jam_masuk = clockFormat.format(clock);
        String jam_keluar = "-";
        mApiService.simpanAbsenRequest(tanggal_absen,
                jam_masuk,
                jam_keluar,
                kode_pegawai)
                        ...
                        if (response.isSuccessful()){
                            ...
                            try {
                                ...
                                if (jsonRESULTS.getString("error").equals("false")){
                                    ...
                                    Intent intent = new Intent(FaceInActivity.this, CheckActivity.class);
